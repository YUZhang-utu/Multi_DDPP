...
class MoleculeDataset(torch.utils.data.Dataset):
    def __init__(self, _smiles_list, targets, exp_environment_texts=None, text_processor=None):

        self._smiles_list = _smiles_list
        self.targets = targets
        self.has_exp_data = exp_environment_texts is not None and text_processor is not None

        if self.has_exp_data:
            self.exp_features = text_processor.transform(exp_environment_texts)
        else:
            self.exp_features = None
